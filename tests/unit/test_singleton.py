...
class TestLoggerConfiguration:
    ...
    def test_logger_uses_app_name_from_config(
    ...
    def test_logger_uses_default_app_name(
        self, mock_logger_instance, clean_environment
    ):
    ...
    def test_get_effective_level_matches_logger(
        self, mock_logger_instance, clean_environment
    ):
...
class TestConfigurationIntegration:
    ...
    def test_thread_safe_configuration_loading(
        self, mock_logger_instance, clean_environment
    ):
